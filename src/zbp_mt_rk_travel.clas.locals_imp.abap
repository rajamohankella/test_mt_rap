CLASS lsc_zmt_rk_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zmt_rk_travel IMPLEMENTATION.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    types:  t_entity_create type table for create zmt_rk_travel,
              t_entity_update TYPE table for update zmt_rk_travel,
              t_entity_rep type table for REPORTED zmt_rk_travel,
              t_entity_err type table for FAILED zmt_rk_travel.

    methods precheck_draft_reuse
        importing
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    ...
    READ ENTITIES OF zmt_rk_travel IN LOCAL MODE
        ENTITY travel
    ...
    LOOP AT lt_travel INTO DATA(ls_travel).
      ...
      IF ( ls_travel-OverallStatus = 'X' ).
        ...
        AUTHORITY-CHECK OBJECT 'ZMTRK_MGR'
        ID 'ACTVT' FIELD '03'.
        IF sy-subrc = 0.
          lv_auth = abap_true.
        ENDIF.
  ...
  METHOD earlynumbering_create.
   ...
   data: entity type STRUCTURE FOR CREATE zmt_rk_travel,
...
*                   ).
  ...
  METHOD copyTravel.
    data: travels type table for create zmt_rk_travel\\Travel,
         bookings_cba type table for create zmt_rk_travel\\Travel\_Booking,
         booksuppl_cba type table for create zmt_rk_travel\\Booking\_BookingSupplement.
...
*       ENDLOOP.
   ...
   MODIFY ENTITIES OF zmt_rk_travel IN LOCAL MODE
       ENTITY travel
