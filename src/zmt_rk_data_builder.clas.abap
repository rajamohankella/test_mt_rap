CLASS zmt_rk_data_builder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zmt_rk_data_builder IMPLEMENTATION.
...
*        output =
 ...
 METHOD fill_master_data.
   data : lt_bp type table of zmt_rk_bpa,
          lt_prod type table of zmt_rk_product.
   append value #(
  ...
  append value #(
   ...
   append value #(
                   ...
                   to lt_prod.
    insert zmt_rk_bpa from table @lt_bp.
    insert zmt_rk_product from table @lt_prod.
 ENDMETHOD.
 METHOD fill_transaction_data.
   ...
   select * from zmt_rkella_bpa into table @data(lt_bpa).
   select * from zmt_rkella_prod into table @data(lt_prod).
   do 50 times.
       ...
       enddo.
   enddo.
   insert zmt_rk_so_hdr from table @lt_so.
   insert zmt_rk_so_item from table @lt_so_i.
 ENDMETHOD.
 METHOD flush.
   delete from : zmt_rk_bpa, zmt_rk_product, zmt_rk_so_hdr, zmt_rk_so_item.
 ENDMETHOD.
ENDCLASS.
