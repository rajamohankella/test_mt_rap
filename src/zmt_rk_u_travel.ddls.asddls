...
define root view entity zmt_rk_u_travel
  as select from /dmo/travel as Travel
  //composition of target_data_source_name as _association_name
  association [1] to ZMT_RK_U_AGENCY         as _Agency       on $projection.AgencyId = _Agency.AgencyId
  association [1] to zmt_rk_u_customer       as _Customer     on $projection.CustomerId = _Customer.CustomerId
