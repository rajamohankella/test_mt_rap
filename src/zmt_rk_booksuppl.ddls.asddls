...
define view entity zmt_rk_booksuppl as select from /dmo/booksuppl_m
 association to parent zmt_rk_booking as _Booking on
 $projection.BookingId = _Booking.BookingId and
   $projection.TravelId = _Booking.TravelId
association[1..1] to zmt_rk_travel as _Travel on
