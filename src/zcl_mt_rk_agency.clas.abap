CLASS zcl_mt_rk_agency DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_mt_rk_agency IMPLEMENTATION.
  METHOD if_rap_query_provider~select.
    DATA:
     lt_business_data TYPE TABLE OF zmt_rk_agency=>tys_z_travel_agency_es_5_type,
