...
define root view entity zmt_rk_travel as select from /dmo/travel_m
--associations - lose coupling to get dependent data
composition[0..*] of zmt_rk_booking as _Booking
--Composition child for travel viz booking
composition[0..*] of zmt_rk_m_attach as _Attachments
