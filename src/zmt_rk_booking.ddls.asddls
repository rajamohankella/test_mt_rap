...
define view entity zmt_rk_booking as select from /dmo/booking_m
composition[0..*] of zmt_rk_booksuppl as _BookingSupplement
association to parent zmt_rk_travel as _Travel on
