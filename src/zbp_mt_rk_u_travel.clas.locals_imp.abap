CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
   ...
   types: tt_travel_failed TYPE table for failed Zmt_rk_U_TRAVEL,
        tt_travel_reported type table for REPORTED Zmt_rk_U_TRAVEL.
...
CLASS lsc_ZMT_RK_U_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZMT_RK_U_TRAVEL IMPLEMENTATION.
